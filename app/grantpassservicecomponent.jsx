      ...
      <Container fluid>
        ...
        >
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/grants-pass/services/companion-care/" passHref>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/grants-pass/services/personal-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/grants-pass/services/24-hour-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/grants-pass/services/veteran-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/grants-pass/services/respite-care/" passHref>
              <div style={{ textAlign: "center" }}>
