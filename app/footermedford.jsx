...
export default function MedfordFooter() {
                    ...
                    <Row>
                        ...
                        <Col md={4}>
                            ...
                            <ul style={{ listStyleType: 'none', padding: 0 }}>
                                <li><a href="/service-areas/medford/services/alzheimers-dementia-care"  className="footer-list-services">Alzheimer's & Dementia Care</a></li>
                                <li><a href="service-areas/medford/services/companion-care" className="footer-list-services">Companion Care</a></li>
                                <li><a href="/service-areas/medford/services/personal-care" className="footer-list-services">Personal Care</a></li>
                                <li><a href="/service-areas/medford/services/respite-care" className="footer-list-services">Respite Care</a></li>
                                <li><a href="/service-areas/medford/services/veteran-care" className="footer-list-services">Veteran Care</a></li>
                                <li><a href="/service-areas/medford/services/24-hour-care" className="footer-list-services">24 Hour Care</a></li>
                            </ul>
                        </Col>
                        ...
                        <h5 className="footer-services "> Get In Touch</h5>
                            ...
                            <div className="social-icons">
                                ...
                                <a href="https://www.instagram.com/interimmf_gp/" target="_blank" rel="noopener noreferrer">
                                    <FaInstagram size={30} />
                                </a>
                                <a href="https://x.com/InterimMF_GP" target="_blank" rel="noopener noreferrer">
                                    <FaTwitter size={30} />
                                </a>
                                <a href="https://www.linkedin.com/company/interim-health-care-of-medford-and-grandpass/" target="_blank" rel="noopener noreferrer">
                                    <FaLinkedin size={30} />
                                </a>
                            </div>
                        </Col>
