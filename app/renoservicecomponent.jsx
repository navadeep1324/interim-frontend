...
export default function RenoservicesComponent() {
  return (
    <div>
      <Container fluid>
        <Row
        ...
        >
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/reno/services/companion-care/" passHref>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/reno/services/personal-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/reno/services/24-hour-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/reno/services/veteran-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/reno/services/respite-care/" passHref>
              <div style={{ textAlign: "center" }}>
