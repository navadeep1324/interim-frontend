...
export default function GrantsPassFooter() {
                    ...
                    <Row>
                        ...
                        <Col md={4}>
                            ...
                            <ul style={{ listStyleType: 'none', padding: 0 }}>
                                ...
                                <li><a href="/service-areas/grants-pass/services/veteran-care" className="footer-list-services">Veteran Care</a></li>
                                <li><a href="/service-areas/grants-pass/services/24-hour-care" className="footer-list-services">24 Hour Care</a></li>
                            </ul>
                        </Col>
