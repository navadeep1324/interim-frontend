...
export default function ReddingservicesComponent() {
  return (
    <div>
      <Container fluid>
        <Row
        ...
        >
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/redding/services/personal-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/redding/services/24-hour-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/redding/services/veteran-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/redding/services/respite-care/" passHref>
              <div style={{ textAlign: "center" }}>
