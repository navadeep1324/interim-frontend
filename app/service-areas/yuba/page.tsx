...
import ChicoFooter from "../../footeryuba";
import SanJoseservicesComponent from "../../sanjoseservicecomponent";
import ChicoNavbarComponent from "../../yubanavcomponent";
import CaregiverCityComponent from "../../caregiversComponentMainCity";
import ChicoserviceComponent from "../../yubaservicecomponent";
...
export default function YubaComponent() {
    ...
    useEffect(() => {
        fetch("https://admin.interimhc.com/api/yubas?populate[maincontent][populate]=*&populate[seo]=*")
                ...
                <Container>
                    <Row className="py-3">
                        <Col md={7} className="py-4" style={{paddingRight:"4%"}}>
                            ...
                            <p>
                            To schedule your care appointment, call us <a href="tel:+1 530-673-0300" className="phone-link">+1 530-673-0300</a> and let us help you with the right care plan!
                            ...
                            <div className="flex py-5" style={{paddingRight:"8%"}}>
                                ...
                                <div className="citynames"><a href="/service-areas/yuba/marysville">Marysville</a> | <a href="/service-areas/yuba/olivehurst">Olivehurst</a> | <a href="/service-areas/yuba/plumas-lake">Plumas Lake</a> | <a href="/service-areas/yuba/loma-rica">Loma Rica</a> | <a href="/service-areas/yuba/live-oak">Live Oak</a> | <a href="/service-areas/yuba/colusa">Colusa</a> | <a href="/service-areas/yuba/williams">Williams</a> | <a href="/service-areas/yuba/maxwell">Maxwell</a> 
                </div>                            </div>
                        </Col>
