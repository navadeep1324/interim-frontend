...
import FooterYuba from "../../../../footerserviceyuba";
    ...
    async function fetchData() {
      try {
        const res = await fetch(
          "https://admin.interimhc.com/api/yuba-personal-cares?populate[maincontent][populate]=*&populate[seo]=*"
        );
  ...
  <Container>
    <Row>
      <Col md="6">
        ...
        <p> {data.maincontent[2].description[3]?.children?.[0]?.text || "Default Text"}</p>
      </Col>
      <Col md="6">
        {renderImage(
