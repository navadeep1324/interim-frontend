            ...
            <div className="bg-light-peach service-section-padding">
                <Container>
                    <Row>
                        {/* First Card */}
                        <Col md={4}>
                            <a href="/service-areas/yuba/services/alzheimers-dementia-care">
                        ...
                        {/* Second Card */}
                        <Col md={4}>
                            <a href="/service-areas/yuba/services/companion-care">
                                <Card className="h-100 cardstyle">
                                    <Image
                        ...
                        {/* Third Card */}
                        <Col md={4}>
                            <a href="/service-areas/yuba/services/personal-care">
                                <Card className="h-100 cardstyle">
                                    <Image
            ...
            <div className="bg-light-peach service-section-padding">
                <Container>
                    <Row>
                        {/* Fourth Card */}
                        <Col md={4}>
                            <a href="/service-areas/yuba/services/respite-care">
                                <Card className="h-100 cardstyle">
                                    <Image
                        ...
                        {/* Fifth Card */}
                        <Col md={4}>
                            <a href="/service-areas/yuba/services/veteran-care">
                                <Card className="h-100 cardstyle">
                                    <Image
                        ...
                        {/* Sixth Card */}
                        <Col md={4}>
                            <a href="/service-areas/yuba/services/24-hour-care">
                                <Card className="h-100 cardstyle">
                                    <Image
