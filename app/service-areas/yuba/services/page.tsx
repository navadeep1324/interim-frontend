        ...
        <Row className="d-flex align-items-center justify-content-center">
            <Col className="d-flex flex-column align-items-center text-center">
                <h2 className="" style={{ fontFamily: "'Merriweather', Georgia, 'Times New Roman', serif", fontSize: '34px', fontWeight: '700', color: '#004B66', paddingTop: '60px' }}>
                    Our Range of Services in Yuba, California
                </h2>
                <p className="homep py-3">
...
<div style={{ backgroundColor: '#fef9f5', padding: '40px 0' }}>
                <Container>
                    <Row>
                        {/* First Card */}
                        <Col md={4} >
                        <a href="/service-areas/yuba/services/alzheimers-dementia-care"> <Card className="h-100 cardstyle">
                                <Image
                        ...
                        {/* Second Card */}
                        <Col md={4}>
                        <a href="/service-areas/yuba/services/companion-care"> <Card className="h-100 cardstyle">
                                <Image
                        ...
                        {/* Third Card */}
                        <Col md={4}>
                        <a href="/service-areas/yuba/services/personal-care"><Card className="h-100 cardstyle">
                                <Image
            ...
            <div style={{ backgroundColor: '#fef9f5', padding: '40px 0' }}>
                <Container>
                    <Row>
                        {/* fourth Card */}
                        <Col md={4} >
                        <a href="/service-areas/yuba/services/respite-care"><Card className="h-100 cardstyle" >
                                <Image
                        ...
                        {/* fifth Card */}
                        <Col md={4}>
                        <a href="/service-areas/yuba/services/veteran-care"> <Card className="h-100 cardstyle">
                                <Image
                        ...
                        {/* sixth Card */}
                        <Col md={4}>
                        <a href="/service-areas/yuba/services/24-hour-care"> <Card className="h-100 cardstyle">
                                <Image
