...
import CarsonFooter from "../../../../footerservicereno";
...
export default function AlzheimerMainComponent() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const res = await fetch(`${API_URL}/api/reno-alzheimer-s-and-dementia-cares?populate[maincontent][populate]=*&populate[seo]=*`);
      ...
      <div className="section1banner">
        <Container>
          ...
          <Col md="6">
              ...
              <p>Reach us today at <a href="tel:+1 775-335-3155" className="phone-link">+1 775-335-3155</a> to learn how we can assist your aging adults!</p>
