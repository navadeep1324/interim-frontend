...
<div style={{ backgroundColor: '#fef9f5', padding: '40px 0' }}>
                <Container>
                    <Row>
                        {/* First Card */}
                        <Col md={4} >
                        <a href="/service-areas/reno/services/alzheimers-dementia-care"><Card className="h-100 cardstyle">
                                <Image
                        ...
                        {/* Second Card */}
                        <Col md={4}>
                        <a href="/service-areas/reno/services/companion-care"> <Card className="h-100 cardstyle">
                                <Image
                        ...
                        {/* Third Card */}
                        <Col md={4}>
                        <a href="/service-areas/reno/services/personal-care"> <Card className="h-100 cardstyle">
                                <Image
            ...
            <div style={{ backgroundColor: '#fef9f5', padding: '40px 0' }}>
                <Container>
                    <Row>
                        {/* fourth Card */}
                        <Col md={4} >
                        <a href="/service-areas/reno/services/respite-care"> <Card className="h-100 cardstyle" >
                                <Image
                        ...
                        {/* fifth Card */}
                        <Col md={4}>
                        <a href="/service-areas/reno/services/veteran-care"> <Card className="h-100 cardstyle">
                                <Image
                        ...
                        {/* sixth Card */}
                        <Col md={4}>
                        <a href="/service-areas/reno/services/24-hour-care"> <Card className="h-100 cardstyle">
                                <Image
