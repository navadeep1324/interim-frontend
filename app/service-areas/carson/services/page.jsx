        ...
        <Row className="d-flex align-items-center justify-content-center">
            <Col className="d-flex flex-column align-items-center text-center">
                <h2 className="" style={{ fontFamily: "'Merriweather', Georgia, 'Times New Roman', serif", fontSize: '34px', fontWeight: '700', color: '#004B66', paddingTop: '60px' }}>
                    Our Range of Services in Carson City
                </h2>
                <p className="homep py-3">
                ...
                <Container>
                    <Row>
                        ...
                        <Col md={4} >
                            ...
                            <Link href="/service-areas/carson/services/alzheimers-dementia-care">
                                <Image
                        ...
                        <Col md={4}>
                            <Card className="h-100 cardstyle">
                            <Link href="/service-areas/carson/services/companion-care">
                                <Image
                        ...
                        <Col md={4}>
                            <Card className="h-100 cardstyle">
                            <Link href="/service-areas/carson/services/personal-care">
                                <Image
            ...
            <div style={{ backgroundColor: '#fef9f5', padding: '40px 0' }}>
                <Container>
                    <Row>
                        ...
                        <Col md={4} >
                            <Card className="h-100 cardstyle" >
                            <Link href="/service-areas/carson/services/respite-care">
                                <Image
                        ...
                        <Col md={4}>
                            <Card className="h-100 cardstyle">
                            <Link href="/service-areas/carson/services/veteran-care">
                                <Image
                        ...
                        <Col md={4}>
                            <Card className="h-100 cardstyle">
                            <Link href="/service-areas/carson/services/24-hour-care">
                                <Image
