...
const renderTextContent = (content) => {
  return content?.children?.map((item, idx) => {
    if (item.type === "link") {
      const isExternalLink = item.url.startsWith("http");  // Check if the link is external
      return (
        <a
          key={idx}
          href={item.url}
          className="phone-link"
          target={isExternalLink ? "_blank" : "_self"}  // Open external links in new tab
          rel={isExternalLink ? "noopener noreferrer" : undefined}  // Security measure for new tabs
        >
        ...
        <Container>
          <Row className="section1row">
            <Col md={7} className="py-5" style={{paddingRight:"4%"}}>
              ...
              <p>
              For a quick consultation, give us a call at <a href="tel:4082866888" className="phone-link">+1 (408) 286-6888</a> and let us help you with the right care plan!
...
<div className="section2city">
  <Container fluid>
    ...
    <Container>
        <Row className="py-3">
            <Col md={2}></Col>
            <Col md={8}><h2 className="heading2" style={{textAlign:'center'}}>Affordable Home Care You Can Trust!</h2>
            <p style={{textAlign:'center'}} className="py-2">Opting for Interim Health Care offers various advantages, particularly in easing the financial burden
...
<Image src={SanJose4} />
           ...
           <p className="py-2"><b>Medicare-Certified Franchises –</b> Many Interim Health Care franchises are Medicare-certified. This means that if your loved ones are eligible for Medicare, its funds can cover specific services provided by our skilled nurses, therapists, or other medical professionals.</p>
            <p><b>Focus on Well-Being –</b> We will guide you throughout the insurance process, allowing you to concentrate on what truly matters – the well-being of your loved ones.</p>
           <p className="py-2">Don’t let confusion about insurance coverage prevent you from accessing the quality care your family deserves. Our experienced team will work diligently to ensure you receive the maximum benefits available to you.</p>
            </Col>
        </Row>
    </Container>
</div>
<div className="section5city py-5">
    <Container>
        <Row>
            <Col>
            <h2 className="heading2city py-3">Enhance Your Loved One’s Golden Years with Interim Health Care            </h2>
           <p style={{textAlign:'center'}}>Take the first step towards enhancing your loved one’s quality of life with our senior home care services. Call us at (408) 286-6888 to discuss your needs and schedule a consultation with our team. Don’t wait—give your loved ones the quality care they deserve. Contact Interim Health Care in San Jose, California today and let us help you make their golden years truly shine.</p>
            </Col>
        </Row>
    </Container>
</div>
<div className="section6city py-5">
  ...
  <Col md={4}>
    <div className="flex py-2">
      ...
      <div><p style={{color:'#004b66'}}><b><a href="/service-areas/san-jose/cupertino" className="city-link">Cupertino</a></b></p></div>
    </div>
    <div className="flex py-2">
      <div className="iconcity"><i class="bi bi-chevron-right"></i></div>
      <div><p style={{color:'#004b66'}}><b><a href="/service-areas/san-jose/evergreen" className="city-link">Evergreen</a></b></p></div>
    </div>
    <div className="flex py-2">
      <div className="iconcity"><i class="bi bi-chevron-right"></i></div>
      <div><p style={{color:'#004b66'}}><b><a href="/service-areas/san-jose/los-altos" className="city-link">Los Altos</a></b></p></div>
    </div>
  </Col>
  <Col md={4}>
    <div className="flex py-2">
      <div className="iconcity"><i class="bi bi-chevron-right"></i></div>
      <div><p style={{color:'#004b66'}}><b><a href="/service-areas/san-jose/los-gatos" className="city-link">Los Gatos</a></b></p></div>
    </div>
    <div className="flex py-2">
      <div className="iconcity"><i class="bi bi-chevron-right"></i></div>
      <div><p style={{color:'#004b66'}}><b><a href="/service-areas/san-jose/milpitas" className="city-link">Milpitas</a></b></p></div>
    </div>
    <div className="flex py-2">
      <div className="iconcity"><i class="bi bi-chevron-right"></i></div>
      <div><p style={{color:'#004b66'}}><b><a href="/service-areas/san-jose/mountain-view" className="city-link">Mountain View</a></b></p></div>
    </div>
  </Col>
  <Col md={4}>
    <div className="flex py-2">
      <div className="iconcity"><i class="bi bi-chevron-right"></i></div>
      <div><p style={{color:'#004b66'}}><b><a href="/service-areas/san-jose/santa-clara" className="city-link">Santa Clara</a></b></p></div>
    </div>
    <div className="flex py-2">
      <div className="iconcity"><i class="bi bi-chevron-right"></i></div>
      <div><p style={{color:'#004b66'}}><b><a href="/service-areas/san-jose/saratoga" className="city-link">Saratoga</a></b></p></div>
    </div>
    <div className="flex py-2">
      <div className="iconcity"><i class="bi bi-chevron-right"></i></div>
      <div><p style={{color:'#004b66'}}><b><a href="/service-areas/san-jose/sunnyvale" className="city-link">Sunnyvale</a></b></p></div>
    </div>
  </Col>
</Row>
