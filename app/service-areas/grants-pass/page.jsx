...
import ChicoFooter from "../../footergrantspass";
...
import ChicoserviceComponent from "../../grantpassservicecomponent";
...
export default function YubaComponent() {
    ...
    useEffect(() => {
        fetch("https://admin.interimhc.com/api/grant-passes?populate[maincontent][populate]=*&populate[seo]=*")
                ...
                <Container>
                    <Row className="py-3 middlealign">
                        <Col md={7} className="py-4" style={{paddingRight:"4%"}}>
                            ...
                            <p>
                            To schedule your care appointment, call us <a href="tel:+1 541-787-3140" className="phone-link">+1 541-787-3140</a> and let us help you with the right care plan!
