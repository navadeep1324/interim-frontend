            ...
            <div className="bg-light-peach service-section-padding">
                <Container>
                    <Row>
                        {/* First Card */}
                        <Col md={4}>
                            <a href="/service-areas/redding/services/alzheimers-dementia-care">
                        ...
                        {/* Second Card */}
                        <Col md={4}>
                            <a href="/service-areas/redding/services/companion-care">
                                <Card className="h-100 cardstyle">
                                    <Image
                        ...
                        {/* Third Card */}
                        <Col md={4}>
                            <a href="/service-areas/redding/services/personal-care">
                                <Card className="h-100 cardstyle">
                                    <Image
            ...
            <div className="bg-light-peach service-section-padding">
                <Container>
                    <Row>
                        {/* Fourth Card */}
                        <Col md={4}>
                            <a href="/service-areas/redding/services/respite-care">
                                <Card className="h-100 cardstyle">
                                    <Image
                        ...
                        {/* Fifth Card */}
                        <Col md={4}>
                            <a href="/service-areas/redding/services/veteran-care">
                                <Card className="h-100 cardstyle">
                                    <Image
                        ...
                        {/* Sixth Card */}
                        <Col md={4}>
                            <a href="/service-areas/redding/services/24-hour-care">
                                <Card className="h-100 cardstyle">
                                    <Image
            ...
            <div className="bg-light-peach service-section-padding">
                <Container>
                    <Row>
                        {/* Seventh Card */}
                        <Col md={4}>
                            <a href="/service-areas/redding/services/palliative-care">
                                <Card className="h-100 cardstyle">
                                    <Image
                                        src={service4} // Replace with actual image path
                                        alt="Respite care"
                                    ...
                                    <Card.Body className="card-body-padding">
                                        ...
                                        <div className="divider-line"></div>
                                        <Card.Text className="card-text">
                                            Designed to ease pain and improve well-being, no matter the stage of illness.
                                        </Card.Text>
                                    </Card.Body>
                                </Card>
                            </a>
                        ...
                        {/* Eighth Card */}
                        <Col md={4}>
                            <a href="/service-areas/redding/services/hospice-care">
                                <Card className="h-100 cardstyle">
                                    <Image
                                        src={service5} // Replace with actual image path
                                        alt="Companion Care"
                                    ...
                                    <Card.Body className="card-body-padding">
                                        ...
                                        <div className="divider-line"></div>
                                        <Card.Text className="card-text">
                                            Personalized care that brings peace and comfort during life’s most difficult moments.
                                        </Card.Text>
                                    </Card.Body>
                                </Card>
                            </a>
                        ...
                        {/* Ninth Card */}
                        <Col md={4}>
                            <a href="/service-areas/redding/services/diabetes-care">
                                <Card className="h-100 cardstyle">
                                    <Image
                                        src={service6} // Replace with actual image path
                                        alt="Personal Care"
                                    ...
                                    />
                                    <Card.Body className="card-body-padding">
                                        <Card.Title className="card-title">Diabetes Care</Card.Title>
                                        <div className="divider-line"></div>
                                        <Card.Text className="card-text">
                                            Tailored diabetes management to live confidently and maintain a healthy lifestyle.
                                        </Card.Text>
                                    </Card.Body>
                                </Card>
                            </a>
