...
import ChicoFooter from "../../footermedford";
import SanJoseservicesComponent from "../../sanjoseservicecomponent";
import ChicoNavbarComponent from "../../medfordnavcomponent";
import CaregiverCityComponent from "../../caregiversComponentMainCity";
import ChicoserviceComponent from "../../medfordservicecomponent";
                ...
                <Container>
                    <Row className="py-3">
                        <Col md={7} className="py-4" style={{paddingRight:"4%"}}>
                            ...
                            <p>
                            To schedule your care appointment, call us <a href="tel:+1 541-779-0054" className="phone-link">+1 541-779-0054</a> and let us help you with the right care plan!
