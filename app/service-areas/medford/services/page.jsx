        ...
        <Row className="d-flex align-items-center justify-content-center">
            <Col className="d-flex flex-column align-items-center text-center">
                <h2 className="" style={{ fontFamily: "'Merriweather', Georgia, 'Times New Roman', serif", fontSize: '34px', fontWeight: '700', color: '#004B66', paddingTop: '60px' }}>
                    Our Range of Services in  Medford, Oregon
                </h2>
                <p className="homep py-3">
                ...
                <Container>
                    <Row>
                        ...
                        <Col md={4} >
                            ...
                            <Link href="/service-areas/medford/services/Alzheimers-Dementia-Care">
                                <Image
                        ...
                        <Col md={4}>
                            <Card className="h-100 cardstyle">
                            <Link href="/service-areas/medford/services/CompanionCare">
                                <Image
                        ...
                        <Col md={4}>
                            <Card className="h-100 cardstyle">
                            <Link href="/service-areas/medford/services/Personal-Care">
                                <Image
            ...
            <div style={{ backgroundColor: '#fef9f5', padding: '40px 0' }}>
                <Container>
                    <Row>
                        ...
                        <Col md={4} >
                            <Card className="h-100 cardstyle" >
                            <Link href="/service-areas/medford/services/Respite-Care">
                                <Image
                        ...
                        <Col md={4}>
                            <Card className="h-100 cardstyle">
                            <Link href="/service-areas/medford/services/Veteran-Care">
                                <Image
                        ...
                        <Col md={4}>
                            <Card className="h-100 cardstyle">
                            <Link href="/service-areas/medford/services/24-Hour-Care">
                                <Image
