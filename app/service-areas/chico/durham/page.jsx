        ...
        <Container>
          ...
          <Accordion className="py-3">
            <Accordion.Item eventKey="0">
              <Accordion.Header>
              When is the right time to seek professional Alzheimer's Care for my loved one? 
               </Accordion.Header>
              <Accordion.Body>
              If you notice increased confusion, wandering, changes in behavior, or if caregiving responsibilities become overwhelming, it might be time to consider our personalized in-home Alzheimer’s Care.               </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="1">
              <Accordion.Header>
              What is Interim Healthcare’s Personal Care for seniors?
              </Accordion.Header>
              <Accordion.Body>
              Our Personal Care involves assisting seniors with daily activities that they may find challenging to perform on their own. This includes helping with bathing, dressing, grooming, toileting and mobility.               </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="2">
              <Accordion.Header>
              Are your caregivers trained regularly in quality standards of in-home care? 
              </Accordion.Header>
              <Accordion.Body>
              Absolutely. Our caregivers undergo comprehensive training in senior care, including safety protocols, first aid, and condition-specific care such as Alzheimer's and dementia care.               </Accordion.Body>
            </Accordion.Item>
          </Accordion>
        </Container>
      </div>
