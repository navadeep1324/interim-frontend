                ...
                <Container>
                    <Row>
                        ...
                        <Col md={4} >
                            ...
                            <Link href="/service-areas/chico/services/alzheimers-dementia-care">
                                <Image
                        ...
                        <Col md={4}>
                            <Card className="h-100 cardstyle">
                            <Link href="/service-areas/chico/services/companion-care">
                                <Image
                        ...
                        <Col md={4}>
                            <Card className="h-100 cardstyle">
                            <Link href="/service-areas/chico/services/personal-care">
                                <Image
            ...
            <div style={{ backgroundColor: '#fef9f5', padding: '40px 0' }}>
                <Container>
                    <Row>
                        ...
                        <Col md={4} >
                            <Card className="h-100 cardstyle" >
                            <Link href="/service-areas/chico/services/respite-care">
                                <Image
                        ...
                        <Col md={4}>
                            <Card className="h-100 cardstyle">
                            <Link href="/service-areas/chico/services/veteran-care">
                                <Image
                        ...
                        <Col md={4}>
                            <Card className="h-100 cardstyle">
                            <Link href="/service-areas/chico/services/24-hour-care">
                                <Image
