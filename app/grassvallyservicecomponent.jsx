      ...
      <Container fluid>
        ...
        >
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/services/companion-care/" passHref>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/services/personal-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/services/24-hour-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/services/veteran-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/services/respite-care/" passHref>
              <div style={{ textAlign: "center" }}>
