...
export default function CarsonservicesComponent() {
  return (
    <div>
      <Container fluid>
        <Row
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/carson/services/companion-care/" passHref>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/carson/services/personal-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/carson/services/24-hour-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/carson/services/veteran-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/carson/services/respite-care/" passHref>
              <div style={{ textAlign: "center" }}>
