...
export default function YubaservicesComponent() {
  return (
    <div>
      <Container fluid>
        <Row
        ...
        >
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/yuba/services/companion-care/" passHref>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/yuba/services/personal-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/yuba/services/24-hour-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/yuba/services/veteran-care/" passHref>
              <div style={{ textAlign: "center" }}>
          ...
          <Col md={2} className="servicecoloumcity mx-1">
            <Link href="/service-areas/yuba/services/respite-care/" passHref>
              <div style={{ textAlign: "center" }}>
